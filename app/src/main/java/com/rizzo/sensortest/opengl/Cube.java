package com.rizzo.sensortest.opengl;
...
public class Cube {
    ...
    float[] mVerticesData = new float[]{
            ...
            ////////////////////////////////////////////////////////////////////
            // Triangle 1
            -size, size/30, size*3, // top-left
            -size, -size, size*3, // bottom-left
            size, -size, size*3, // bottom-right
            // Triangle 2
            size, -size, size*3, // bottom-right
            size, size/30, size*3, // top-right
            -size, size/30, size*3, // top-left
            ////////////////////////////////////////////////////////////////////
            // BACK
            ////////////////////////////////////////////////////////////////////
            ...
            // Triangle 1
            -size, size/30, -size*3, // top-left
            -size, size/30, size*3, // bottom-left
            size, size/30, size*3, // bottom-right
            // Triangle 2
            size, size/30, size*3, // bottom-right
            size, size/30, -size*3, // top-right
            -size, size/30, -size*3, // top-left
